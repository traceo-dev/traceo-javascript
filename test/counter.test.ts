...
describe("Gauge", () => {
  ...
  it("Should decrement value by 1", () => {
    counter.increment("test-3", 100).decrement("test-3");
  ...
  it("Should decrement value by provided value", () => {
    counter.increment("test-4", 100).decrement("test-4", 50);
  ...
  it("Should reset one of value", () => {
    counter.increment("test-5", 21).increment("test-6", 37).reset("test-5");
